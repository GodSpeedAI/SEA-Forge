...
On branch `full-spec`. Tasks 1–14 are committed through `85b2540`. Task 15 (M7 environment contracts + command evaluators) is implemented, conformance-green, and uncommitted.
...
- Tasks 16–17 from the implementation plan (M8 artifact-to-IP and the §18 DoD sweep).
