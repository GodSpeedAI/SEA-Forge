...
On branch `full-spec`. Tasks 1–13 are committed through `9ec5e20`. Task 14 (M6 SeaCell federation prep) is implemented, conformance-green, and uncommitted.
...
- Tasks 15–17 from the implementation plan (M7 environments/evaluators through M8 artifact-to-IP and the §18 DoD sweep).
