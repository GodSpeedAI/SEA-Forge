...
- **Oracle Rationale**: Approval appr-101 decided with verdict='approve' by actor='approver_alice'; append-only journal preserved.

### Consequential Visual Evidence
- **CJ06-001-entry-approval-inbox.png** (entry): Approval inbox route
  ![CJ06-001-entry-approval-inbox.png](../../screenshots/CJ06/CJ06-001-entry-approval-inbox.png)
- **CJ06-002-authority-approval-boundary.png** (authority_boundary): Separation of duty check and pending decision context
  ![CJ06-002-authority-approval-boundary.png](../../screenshots/CJ06/CJ06-002-authority-approval-boundary.png)
- **CJ06-003-settlement-decision-committed.png** (settlement_state): Human decision committed to approvals journal
  ![CJ06-003-settlement-decision-committed.png](../../screenshots/CJ06/CJ06-003-settlement-decision-committed.png)
