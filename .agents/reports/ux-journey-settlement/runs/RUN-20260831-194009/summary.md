...
**Run ID**: `RUN-20260831-194009`
**Timestamp**: `2026-08-31T19:41:34.054806+00:00`
**Commit**: `16c414c8ef85373d64a03d5c38ed6af9615ff587`
**Browser Driver**: `agent-browser 0.34.0`
**Verdict**: **5/12 CANONICAL JOURNEYS PASSED**
...
| --- | --- | :---: | :---: | :---: | --- |
| **CJ01** | Establish Trusted Cell Context | `FAIL` | `ERROR` | 0 | ENTRY |
| **CJ02** | Discover Lawful Affordances | `FAIL` | `ERROR` | 0 | ENTRY |
| **CJ03** | Ground Work in Semantic Meaning | `PASS` | `ACCEPTED` | 2 | — |
| **CJ04** | Form and Commit a Governed Case | `FAIL` | `ERROR` | 0 | ENTRY |
| **CJ05** | Navigate and Adapt a Live Case | `UNTESTED` | `NONE` | 0 | ENTRY |
| **CJ06** | Resolve Human Judgment and Approval | `FAIL` | `ERROR` | 0 | ENTRY |
| **CJ07** | Execute Governed Work | `PASS` | `ACCEPTED` | 2 | — |
| **CJ08** | Monitor, Intervene, and Recover | `FAIL` | `ERROR` | 0 | ENTRY |
| **CJ09** | Evaluate, Settle, and Audit Outcomes | `FAIL` | `ERROR` | 0 | ENTRY |
...
See `coverage.json` for exact counts. Canonical journey coverage: 5/12 passed out of 11 tested.
...
- **Visual Evidence**: Screenshots captured at consequential state boundaries across every journey under `.agents/reports/ux-journey-settlement/runs/RUN-20260831-194009/screenshots/`.
