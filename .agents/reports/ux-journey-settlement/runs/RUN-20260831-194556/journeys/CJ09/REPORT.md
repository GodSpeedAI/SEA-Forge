...
- **Oracle Rationale**: Settlement independently verified: status='accepted' with 1 criteria basis entries; envelope attributably linked; evidence digest recomputation matched.

### Consequential Visual Evidence
- **CJ09-001-entry-evidence-index.png** (entry): Evidence index route
  ![CJ09-001-entry-evidence-index.png](../../screenshots/CJ09/CJ09-001-entry-evidence-index.png)
- **CJ09-002-affordance-criteria-settlement.png** (affordance_discovery): Run record criteria vs evidence pairing and settlement basis
  ![CJ09-002-affordance-criteria-settlement.png](../../screenshots/CJ09/CJ09-002-affordance-criteria-settlement.png)
- **CJ09-003-settlement-audit-proof.png** (settlement_state): Attributable evidence and independent settlement verified
  ![CJ09-003-settlement-audit-proof.png](../../screenshots/CJ09/CJ09-003-settlement-audit-proof.png)
